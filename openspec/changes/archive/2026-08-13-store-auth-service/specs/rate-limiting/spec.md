...
The system SHALL connect to a Redis instance using the `REDIS_URL` environment variable. The Redis client SHALL be initialized at service startup alongside the database client.
