# request-sanitization Specification

## Purpose
HTTP request body payload size limiting, string input trimming, email lowercase normalization, and XSS/HTML control character sanitization across incoming HTTP requests.
