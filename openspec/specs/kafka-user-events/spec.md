...
## Purpose
Background Kafka consumer worker for processing asynchronous user lifecycle domain events (`user.banned`, `user.deleted`) to trigger token revocation and credential synchronization.
